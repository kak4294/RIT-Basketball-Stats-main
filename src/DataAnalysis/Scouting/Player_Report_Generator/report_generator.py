...
def main():
    # Load JSON data
    with open('/Users/kylekrebs/Documents/RIT-Basketball-Stats-main/data/2023_24/cleaned/reports/Matt-Caggiano-11-06-2024/insights.json') as f:
        data = json.load(f)
    ...
    with open('inputed_stats_report.tex', 'w') as f:
